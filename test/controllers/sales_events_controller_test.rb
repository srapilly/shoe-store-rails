...
class SalesEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_event" do
    assert_difference("SalesEvent.count") do
      post sales_events_url, params: { sales_event: { inventory: @sales_event.inventory, model: @sales_event.model, store: @sales_event.store } }
    end
  ...
  test "should update sales_event" do
    patch sales_event_url(@sales_event), params: { sales_event: { inventory: @sales_event.inventory, model: @sales_event.model, store: @sales_event.store } }
